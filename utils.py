...
class Recorder:
    ...
    def stop_rec(self, progress_bar: BarWindow) -> None:
        sd.stop()
        self.is_recording = False
    ...
    def create_from_audio(self, path: str, progress_bar: BarWindow) -> None:
...
ICON: str = resource_path("images/icon.ico")
